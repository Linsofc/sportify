...
async function getBotResponse(userMessage) {
    ...
    messages: [
      {
        ...
        content: `Hi! Saya adalah Lins AI menggunakan model Meta LLaMA. Saya dibuat oleh perusahaan bernama Lins Officiall. 
                Saya adalah Linsofc, berbicara dalam bahasa Indonesia, dan selalu berusaha membantu dengan cara yang ramah dan menyenangkan. Ayo ngobrol`,
      },
      {
        role: "user",
        content: userMessage,
  ...
  try {
    ...
    return "Silahkan Coba Kembali Beberapa Saat.";
  }
}
...
function addChatMessage(message, sender) {
  ...
  avatar.classList.add("avatar", "bg-gray-300");
